...
$sql = "SELECT p.*, 
        ...
        AND p.pharmacy_id = ?
        AND p.refill_status = 'refill_requested' OR 'new'
...
<div class="dashboard-header d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="btn-group">
        <a href="?page=view_all_prescriptions" class="btn btn-outline-primary">
            <i class="fas fa-list"></i> All Prescriptions
        </a>
        <a href="?page=prescription_history" class="btn btn-outline-secondary">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <a href="reject_refill?id=<?php echo htmlspecialchars($row["id"]); ?>" 
